...
std::vector<NLateralDescriptor> NlateralMap_point_matching_w_average_geodesic(TrilateralMesh* m, Skeleton& skeleton,
	...
	float area_dif_param, float skel_point_dist_param, float paths_dif_param,float min_geo_tau, int avg_n_ring, int skel_depth_param,
	float tri_hist_param , float distance_to_mid_param ,int N);