...
static std::vector<TrilateralDescriptor> get_trilateral_points_using_closest_pairs(MeshFactory& mesh_fac, const int& selected_index , std::vector<unsigned int>& indices )
{
	Mesh* m = &mesh_fac.mesh_vec[selected_index];
